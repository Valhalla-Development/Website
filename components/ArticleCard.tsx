...
export function ArticleCard({ className, image, link, title, description, author, rating, ...others }: ArticleCardProps & Omit<ComponentPropsWithoutRef<"div">, keyof ArticleCardProps>) {
